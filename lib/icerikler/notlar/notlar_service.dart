...
import 'package:flutter_app/icerikler/notlar/notlar.dart';
...
class TodoService{
  ...
  void _createDb(Database db,int version) async {
    await db.execute('CREATE TABLE todos(id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT,description TEXT,isDone INT)');
}
